<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="TaxiBooking.WebForm1" %>
                        ...
                        <div class="container">
                            <div class="row fullscreen d-flex align-items-center justify-content-between">
                                <div class="banner-content col-lg-6 col-md-6 ">
                                    ...
                                    <h1 class="text-uppercase">911 999 911 </h1>
                                ...
                                <div class="col-lg-4  col-md-6 header-right">
                                    ...
                                    <form class="form">
                                        <div class="from-group">
                                            <!-- <input  type="text" name="name"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your name'"> -->
                                            <asp:TextBox ID="txtName" class="form-control txt-field" placeholder="Your name" runat="server"></asp:TextBox>
                                            ...
                                            <asp:TextBox ID="txtEmail" class="form-control txt-field" placeholder="Email address" runat="server"></asp:TextBox>                                             
                                            ...
                                            <asp:TextBox ID="txtPhone" class="form-control txt-field" placeholder="Phone number" runat="server"></asp:TextBox>                                                                                         
                                        </div>
                                        <div class="form-group">
                                            <div class="default-select" id="default-select">
                                                ...
                                                <asp:DropDownList ID="fromDestination" runat="server">
                                                    <asp:ListItem>Select From Destination :</asp:ListItem>
                                        ...
                                        <div class="form-group">
                                            <div class="default-select" id="default-select2">
                                                ...
                                                <asp:DropDownList ID="toDestination" runat="server">
                                                    <asp:ListItem>Select To Destination :</asp:ListItem>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:Button ID="submit" class="btn btn-default btn-lg btn-block text-center text-uppercase" runat="server" Text="Make Reservation" OnClick="submit_Click" />
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-lg-4 single-service">
                                    <span class="lnr lnr-car"></span><a href="#">
                                    <h4>Taxi Service</h4>
                                    </a>
                                    <p>
                                ...
                                <div class="col-lg-4 single-service">
                                    <span class="lnr lnr-briefcase"></span><a href="#">
                                ...
                                <div class="col-lg-4 single-service">
                                    <span class="lnr lnr-bus"></span><a href="#">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-lg-4 single-gallery">
                                    ...
                                    <img class="img-fluid" src="img/g1.jpg" alt=""></a> <a href="img/g4.jpg" class="img-gal">
                                    <img class="img-fluid" src="img/g4.jpg" alt=""></a>
                                </div>
                                <div class="col-lg-4 single-gallery">
                                    <a href="img/g2.jpg" class="img-gal">
                                    <img class="img-fluid" src="img/g2.jpg" alt=""></a> <a href="img/g5.jpg" class="img-gal">
                                    <img class="img-fluid" src="img/g5.jpg" alt=""></a>
                                </div>
                                <div class="col-lg-4 single-gallery">
                                    <a href="img/g3.jpg" class="img-gal">
                                    <img class="img-fluid" src="img/g3.jpg" alt=""></a> <a href="img/g6.jpg" class="img-gal">
                                    <img class="img-fluid" src="img/g6.jpg" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </section>
